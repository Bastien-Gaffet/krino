...
const FR: Dico = {
  ...
  "tuto.9": "Dès qu'une sélection existe, cette barre apparaît en bas : ♥ pour mettre en favori, « Déplacer dans l'album » pour ranger dans une collection, la corbeille pour jeter, ou « Annuler » pour tout désélectionner.",
...
const EN: Dico = {
  ...
  "tuto.9": "As soon as a selection exists, this bar appears at the bottom: ♥ to mark as favorite, “Move to album” to file it into a collection, the trash icon to discard, or “Clear selection” to deselect everything.",
