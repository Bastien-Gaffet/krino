...
const FR: Dico = {
  ...
  "accueil.recents": "Dossiers récents",
  ...
  "tuto.0": "Bienvenue dans Krino. Choisis un dossier de départ contenant tes photos et vidéos (et éventuellement des sous-dossiers), même en vrac : Krino s'occupe ensuite du tri et du rangement. Ce tutoriel utilise un dossier de démonstration — tes vraies photos ne sont pas touchées.",
  ...
  "tuto.7": "La barre latérale est le cœur de Krino : Trier pour le tri par cartes, Galerie pour tout revoir, tes Albums, les Doublons, le Rangement et la Corbeille. On fait le tour de chacun.",
  "tuto.8": "La Galerie affiche tout, des plus récentes en haut vers les plus anciennes. Sélectionne plusieurs photos avec Ctrl+clic, Maj+clic, ou en traçant un rectangle à la souris ; double-clique une photo pour l'ouvrir en grand (glisse ou utilise les flèches pour naviguer, clique en dehors pour fermer).",
  "tuto.9": "Dès qu'une sélection existe, cette barre apparaît en bas : le cœur pour mettre en favori, « Déplacer dans l'album » pour ranger dans une collection, la corbeille pour jeter, ou « Annuler » pour tout désélectionner.",
  "tuto.10": "La page Albums réunit tous tes albums (avec un aperçu façon carte de mois) et les Favoris. Clique une carte pour l'ouvrir, ou « + » pour en créer un nouveau. Dans la barre latérale, seuls les 3 premiers albums restent visibles en permanence (réordonnables par glisser-déposer) ; les Favoris y sont toujours affichés.",
  "tuto.11": "Depuis la Galerie, « Déplacer dans l'album » ouvre cette même page : choisis un album pour y transférer la sélection, puis tu reviens directement à la Galerie, au même endroit du défilement.",
  "tuto.12": "Les Doublons : choisis « exacts » (fichiers strictement identiques) ou « semblables » (photos recompressées ou redimensionnées, avec une tolérance réglable), puis « Analyser ». Dans chaque groupe, un clic bascule garder/jeter (plus de grisage, l'état choisi reste lisible) ; avant l'envoi à la corbeille, un écran de vérification récapitule tout ce qui va être déplacé.",
  "tuto.13": "Le Rangement propose un aperçu de l'arborescence Année/Mois qui sera créée, avec le nombre de fichiers par dossier, avant toute confirmation. Le dernier rangement peut toujours être annulé d'un clic.",
  "tuto.14": "La Corbeille est maintenant une grille comme la Galerie : sélectionne plusieurs fichiers (Ctrl/Maj/rectangle) puis « Restaurer » ou « Supprimer définitivement ».",
  "tuto.15": "C'est tout ! Réglages te permet de changer le thème, la langue, les raccourcis, le regroupement, et de revoir ce tutoriel. Bon tri !",
  ...
  "maj.aLaFermeture": "À la fermeture",
  "maj.verification": "Vérification…",
  ...
  "maj.erreurFermeture": "Le téléchargement de la mise à jour a échoué : {e}\nKrino se ferme normalement.",
  ...
  "albums.aide": "Les favoris (marqués pendant le tri avec le cœur) et les albums sont des collections : les fichiers restent à leur place. « Exporter » copie l'album dans le dossier Albums/<nom>. Clique sur une vignette pour la sélectionner.",
  ...
  "albums.videFavoris": "Aucun favori — pendant le tri, appuie sur F ou clique sur le cœur pour marquer une photo.",
...
const EN: Dico = {
  ...
  "accueil.recents": "Recent folders",
  ...
  "tuto.0": "Welcome to Krino. Pick a starting folder that has your photos and videos (and maybe subfolders), even a messy pile: Krino takes care of sorting and organizing from there. This tutorial uses a demo folder — your real photos are untouched.",
  ...
  "tuto.7": "The sidebar is the heart of Krino: Sort for card-based sorting, Gallery to review everything, your Albums, Duplicates, Organizing and the Trash. Let's take a quick tour of each.",
  "tuto.8": "The Gallery shows everything, newest at the top down to the oldest. Select several photos with Ctrl+click, Shift+click, or by dragging a rectangle with the mouse; double-click a photo to open it full-screen (swipe or use the arrow keys to navigate, click outside to close).",
  "tuto.9": "As soon as a selection exists, this bar appears at the bottom: the heart to mark as favorite, “Move to album” to file it into a collection, the trash icon to discard, or “Clear selection” to deselect everything.",
  "tuto.10": "The Albums page gathers all your albums (with a month-card-style preview) and Favorites. Click a card to open it, or “+” to create a new one. In the sidebar, only the first 3 albums stay permanently visible (reorderable by drag & drop); Favorites is always shown there too.",
  "tuto.11": "From the Gallery, “Move to album” opens this same page: pick an album to transfer the selection into it, then you land right back in the Gallery, at the same scroll position.",
  "tuto.12": "Duplicates: choose “exact” (strictly identical files) or “similar” (recompressed or resized photos, with an adjustable tolerance), then “Analyze”. In each group, a click toggles keep/trash (no more graying out — the chosen state stays readable); before anything is sent to the trash, a review screen sums up everything that will be moved.",
  "tuto.13": "Organizing shows a preview of the Year/Month folder tree that will be created, with the file count per folder, before any confirmation. The last organizing run can always be undone with one click.",
  "tuto.14": "The Trash is now a grid just like the Gallery: select several files (Ctrl/Shift/rectangle) then “Restore” or “Delete permanently”.",
  "tuto.15": "That's it! Settings lets you change the theme, language, shortcuts, grouping, and replay this tutorial. Happy sorting!",
  ...
  "maj.aLaFermeture": "On close",
  "maj.verification": "Checking…",
  ...
  "maj.erreurFermeture": "Downloading the update failed: {e}\nKrino will close normally.",
  ...
  "albums.aide": "Favorites (marked during sorting with the heart) and albums are collections: files stay where they are. “Export” copies the album into the Albums/<name> folder. Click a thumbnail to select it.",
  ...
  "albums.videFavoris": "No favorites yet — while sorting, press F or click the heart to mark a photo.",
